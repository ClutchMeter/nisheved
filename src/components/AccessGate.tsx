...
import { IconFunnel, IconLock, IconTelegram, IconArrow } from "./icons";

export const ACCESS_CODES = ["NISH2026", "GAID2026", "VIP365", "PDF2026", "DOHOD100"];

export default function AccessGate({ onUnlock }: { onUnlock: (mode: "code" | "demo") => void }) {
        ...
        <div className="w-full max-w-md">
          <div className="panel overflow-hidden">
            ...
            <div className="p-7 sm:p-8">
              ...
              <p className="mt-5 font-mono text-[9.5px] text-dim leading-relaxed text-center">
