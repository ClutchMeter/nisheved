  ...
  return (
    <section id="quiz" className="py-20 px-5 sm:px-8 max-w-4xl mx-auto">
      ...
      <h2 className="font-display font-extrabold text-[clamp(1.7rem,3.6vw,2.9rem)] leading-[1.08] tracking-tight mb-4">
        Не знаешь, с чего начать? — <span className="text-mint">ответь на 5 вопросов</span>
      </h2>
      <p className="text-mute mb-8 text-[14px] leading-relaxed max-w-xl">Сканер проанализирует твои ответы и покажет топ-3 ниши, которые подходят именно тебе. Займёт меньше минуты.</p>
