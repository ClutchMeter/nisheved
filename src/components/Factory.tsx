...
const botScript = (n: Niche, kw: string) => [
  ...
  { step: "3 · Оффер", text: `Подписка «Нишевед»: все 12 гайдов + фабрика продуктов + обновления каждый месяц. 990 ₽/мес, 1 990 ₽/квартал или 4 990 ₽ навсегда. Окупается с одной продажи гайда под своим брендом.` },
  ...
  { step: "6 · Дожим (24 ч)", text: `Привет! Уже заходил(а) в библиотеку? Если есть вопросы по гайдам — отвечу. Напомню: новые гайды добавляются каждый месяц, подписка их открывает автоматически.` },
];
