...
const botScript = (n: Niche, kw: string) => [
  { step: "1 · Приветствие", text: `Привет! Ты написал(а) слово «${kw}» — значит, видел(а) мой рилс. Отправляю то, что обещал(а): ${n.product.name}. Жми кнопку ниже 👇` },
  { step: "2 · Прогрев", text: `Внутри: метод по шагам, справочная таблица с цифрами, готовые шаблоны и чек-листы. Всё по шагам, без воды.` },
  { step: "3 · Оффер", text: `Полная версия — ${n.price} ₽ (вместо ${n.price * 3} ₽ до конца недели). Бонусом: шаблоны из гайда отдельными файлами.` },
  { step: "4 · Оплата", text: `Кнопка «Купить» → оплата картой или Telegram Stars → файл приходит в чат автоматически. Не получилось — напиши «ПОДДЕРЖКА».` },
  { step: "5 · Выдача", text: `Вот твой PDF 📄 Начни с главы 1 — она займёт 10 минут. Пришли скрин результата со словом РЕЗУЛЬТАТ — лучшие кейсы попадают в закрытый чат.` },
  { step: "6 · Дожим (24 ч)", text: `Привет! Уже открывал(а) гайд? Если есть вопросы — отвечу. И для тех, кто хочет быстрее: ${n.upsell}.` },
];
                    ...
                    <div className="flex gap-4 rounded-xl border border-dashed border-mint/40 bg-mint/5 px-4 py-3.5">
                      ...
                      <div>
                        ...
                        <p className="font-mono text-[10.5px] text-mute leading-relaxed mt-1">
                          ...
                          бесплатно за подписку в боте, прогревает до покупки.
                        </p>
                      </div>
                    </div>
