...
const LADDER = [
  {
    ...
    time: "недели 1–4",
    levers: ["Один гайд за 990 ₽ в одной нише", "1–2 рилса в день, кодовое слово под каждым", "Бот @nisheved_bot: Stars-оплата и автовыдача"],
  },
  {
    sum: "30 → 60к",
    tone: "text-sky",
          ...
          <div className="lg:col-span-5 flex flex-col gap-3">
            ...
            <div className="panel rounded-2xl p-5 border-coral/30 relative overflow-hidden">
              ...
              <ol className="space-y-2">
                {[
                  <>Подключи <b className="text-fog">@nisheved_bot</b> к автоответам: ManyChat ловит кодовое слово и шлёт ссылку в Директ.</>,
